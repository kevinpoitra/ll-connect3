...
#include <memory>
#include "../../../src/widgets/customslider.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CustomSlider_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CustomSlider_t qt_meta_stringdata_CustomSlider = {
    {
        QT_MOC_LITERAL(0, 12),  // "CustomSlider"
        QT_MOC_LITERAL(13, 12),  // "valueChanged"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 5),  // "value"
        QT_MOC_LITERAL(33, 20)   // "onSliderValueChanged"
    },
    "CustomSlider",
    "valueChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CustomSlider[] = {
...
Q_CONSTINIT const QMetaObject CustomSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_CustomSlider.offsetsAndSizes,
    qt_meta_data_CustomSlider,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CustomSlider_t,
        // Q_OBJECT / Q_GADGET
...
void CustomSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CustomSlider::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomSlider::valueChanged(int _t1)
{
